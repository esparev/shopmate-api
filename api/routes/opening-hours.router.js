...
const OpeningHourService = require('../services/opening-hours.service');
const {
	getOpeningHourSchema,
	createOpeningHourSchema,
	updateOpeningHourSchema,
} = require('../schemas/opening-hours.schema');
 ...
 */
const getOpeningHour = async (req, res, next) => {
	try {
		const { id } = req.params;
 ...
 */
const updateOpeningHour = async (req, res, next) => {
	try {
		const { id } = req.params;
		const { body: openingHour } = req;
